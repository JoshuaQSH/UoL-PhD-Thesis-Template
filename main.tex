...
% Constants
%%%%%%
\newcommand{\theAuthor}{Shenghao Qiu}
\newcommand{\authorEmail}{sc19sq@leeds.ac.uk}
\newcommand{\myTitle}{Accelerating deep learning workloads by optimising distributed communications and computation kernel}
